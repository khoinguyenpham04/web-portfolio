...
summary: "A to-do list app built with Next.js, featuring task management, lists, and a clean user interface."
images:
...
[**Try it out ➔**](https://to-do-list-v2-alpha.vercel.app/)
...
1. **Clone the repository:**
   ```sh
   git clone https://github.com/khoinguyenpham04/ToDoApp.git
   cd ToDoApp
   ```
